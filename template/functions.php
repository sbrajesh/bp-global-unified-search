...
function bpmag_get_search_query() {
	$term = '';
...
function bpmag_show_member_search() {
	...
	<div class="members-search-result search-result">
		...
		<?php bp_locate_template( array( 'members/members-loop.php' ), true ); ?>
	<?php global $members_template;
	if ( $members_template->total_member_count > 1 ):
		?>
		<a href="<?php echo untrailingslashit( get_permalink( buddypress()->pages->members->id ) ) . '/?s=' .  bpmag_get_search_query() ?>" ><?php _e( sprintf( 'View all %d matched Members', $members_template->total_member_count ), "bpmag" ); ?></a>
	<?php endif; ?>
	</div>
	<?php
}
...
function bpmag_show_activity_search() {
	...
	<?php bp_locate_template( array( 'activity/activity-loop.php' ), true ); ?>
		...
		<a href="<?php echo untrailingslashit( get_permalink( buddypress()->pages->activity->id ) ) . '/?s=' . bpmag_get_search_query() ?>" ><?php _e( "View all matched updates", "bpmag" ); ?></a>
	</div>
	<?php
	//endif;
}
...
function bpmag_show_site_blog_search() {
	...
	<?php bp_locate_template( array( 'search-loop.php' ), true ); ?>
		<a href="<?php echo bp_get_root_domain() . '/?s=' . bpmag_get_search_query() ?>" ><?php _e( "View All matched Posts", "bpmag" ); ?></a>
	</div>
	<?php
}
...
function bpmag_show_blogs_search() {
	...
	<?php bp_locate_template( array( 'blogs/blogs-loop.php' ), true ); ?>
		<a href="<?php echo untrailingslashit( get_permalink( buddypress()->pages->blogs->id ) ) . '/?s=' . bpmag_get_search_query() ?>" ><?php _e( "View All matched Blogs", "bpmag" ); ?></a>
	</div>
	<?php
}
...
function bpmag_show_forums_search() {
	...
	<?php bp_locate_template( array( 'forums/forums-loop.php' ), true ); ?>
		<a href="<?php echo untrailingslashit( get_permalink( buddypress()->pages->forums->id ) ) . '/?s=' . bpmag_get_search_query() ?>" ><?php _e( "View All matched forum posts", "bpmag" ); ?></a>
	</div>
	<?php
}
...
function bpmag_show_bbpress_topic_search() {
	...
	<div class="bbp-topic-search-result search-result">
		...
		?>
		<a href="<?php echo get_permalink( $page ) . '?ts=' . bpmag_get_search_query() ?>" ><?php _e( "View All matched topics", "bpmag" ); ?></a>
	</div>
	<?php
}
